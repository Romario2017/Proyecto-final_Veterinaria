...
<!--                                           <button class="btn btn__primary" type="button" data-toggle="modal" id="id_btnModal_verReserva" data-target="#id_modal_verReserva"> -->
<!--                                         	<i data-feather="plus"></i> -->
<!--                                         	Ver -->
<!--                                         </button> -->
                                    </div>
    ...
    <div class="container-fluid">
		<!--  VER REGISTRO CITAS DETALLE -->
    	<div class="modal fade p-0" id="id_modal_verReserva">
    						 ...
    						 <div class="row mt-2">
					            <div class="col-12 justify-content-center align-items-center d-flex">
					                <main class="col-12 col-md-11">
					                    <form id="ver_id_form_registraCita">
					                    
					                    <input type="text" id="ver_id_codigo_propietario" name="codigo_propietario" class="d-none">
					                   ...
					                   <div class="form-group row">
										...
										<div class="form-group row align-items-center mx-auto">
											<div class="col-12 col-md-3 mb-3">
												<div class="form-floating">
													<input type="text" name="codigo_mascota" class="form-control" id="ver_id_codigo_mascota" readonly>
													<label for="ver_id_codigo_mascota">Código</label>
												</div>
											</div>
											<div class="col-12 col-md-5 mb-3">
												<div class="form-floating">
													<input type="text" name="nombre_mascota" class="form-control" id="ver_id_nombre_mascota" readonly>
													<label for="ver_id_nombre_mascota">Nombre de Mascota</label>
												</div>
											</div>
											
											<div class="col-12 col-md-4 mb-3">
												<div class="form-floating">
													<input type="text" name="codigo_color_mascota" class="form-control" id="ver_id_color_mascota" readonly>
													<label for="ver_id_color_mascota">Color</label>
												</div>
											</div>
										</div>
										...
										<div class="form-group row align-items-center mx-auto">
											<div class="col-12 col-md-3 mb-3">
												<div class="form-floating">
													<input type="text" name="codigo_sexo_mascota" class="form-control" id="ver_id_sexo_mascota" readonly>
													<label for="ver_id_sexo_mascota">Sexo</label>
												</div>
											</div>
											<div class="col-12 col-md-3 mb-3">
												<div class="form-floating">
													<input type="text" name="codigo_especie_mascota" class="form-control" id="ver_id_especie_mascota" readonly>
													<label for="ver_id_especie_mascota">Especie</label>
												</div>
											</div>
											<div class="col-12 col-md-3 mb-3">
												<div class="form-floating">
													<input type="text" name="codigo_raza_mascota" class="form-control" id="ver_id_raza_mascota" readonly>
													<label for="ver_id_raza_mascota">Raza</label>
												</div>
											</div>
					                    ...
					                    <div class="form-group row align-items-center mx-auto">
											<div class="col-12 col-md-2 mb-3">
												<div class="form-floating">
													<input type="text" name="codigo_servicio" class="form-control" id="ver_id_codigo_servicio" readonly>
													<label for="ver_id_codigo_servicio">Código</label>
												</div>
											</div>
											
											<div class="col-12 col-md-4 mb-3">
												<div class="form-floating">
													<input type="text" name="nombre_servicio" class="form-control" id="ver_id_nombre_servicio" readonly>
													<label for="ver_id_nombre_servicio">Nombre de Servicio</label>
												</div>
											</div>
											
											<div class="col-12 col-md-3 mb-3">
												<div class="form-floating">
													<input type="text" name="codigo_tipo_servicio" class="form-control" id="ver_id_tipo_servicio" readonly>
													<label for="ver_id_tipo_servicio">Tipo</label>
												</div>
											</div>
											<div class="col-12 col-md-3 mb-3">
												<div class="form-floating">
													<input type="text" name="codigo_especialidad" class="form-control" id="ver_id_especialidad_servicio" readonly>
													<label for="ver_id_especialidad_servicio">Especialidad</label>
												</div>
											</div>
										</div>
										...
										<div class="form-group row align-items-center mx-auto">
											<div class="col-12 col-md-2 mb-3">
												<div class="form-floating">
													<input type="text" name="codigo_dia_semana" class="form-control" id="ver_id_dia_servicio" readonly>
													<label for="ver_id_dia_servicio">Día</label>
												</div>
											</div>
<!-- 											<div class="col-12 col-md-3 mb-3"> -->
...
<!-- 											</div> -->
											<div class="col-12 col-md-7 mb-6">
												<div class="form-floating">
													<input type="text" name="descripcion_servicio" class="form-control" id="ver_id_descripcion_servicio" readonly>
													<label for="ver_id_descripcion_servicio">Descripción de Servicio</label>
												</div>
											</div>
										</div>
										...
										<div class="form-group row align-items-center mx-auto">
											<div class="col-12 col-md-5 mb-3">
												<div class="form-floating">
													<input type="text" name="codigo_especialista" class="form-control" id="ver_id_especialista_servicio" readonly>
													<label for="ver_id_especialista_servicio">Especialista</label>
												</div>
											</div>
											<div class="col-12 col-md-2 mb-3">
												<div class="form-floating">
													<input type="time" name="inicio_turno_servicio" class="form-control" id="ver_id_hora_inicio_servicio" readonly>
													<label for="ver_id_hora_inicio_servicio">Desde las</label>
												</div>
											</div>
											<div class="col-12 col-md-2 mb-3">
												<div class="form-floating">
													<input type="time" name="fin_turno_servicio" class="form-control" id="ver_id_hora_fin_servicio" readonly>
													<label for="ver_id_hora_fin_servicio">Hasta las</label>
												</div>
											</div>
										...
										<div class="form-group row align-items-center mx-auto">
											<div class="col-12">
												<div class="form-floating">
													<input type="text" name="motivo_cita" class="form-control" id="ver_id_motivo_cita" readonly>
													<label for="ver_id_motivo_cita">Descripción de síntomas</label>
												</div>
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="col-12">
												<div class="form-floating">
													<input type="text" name="motivo_cita" class="form-control" id="ver_id_diagnostico_cita" readonly>
													<label for="ver_id_motivo_cita">Diagnostico</label>
												</div>
											</div>
											</div>
				...
				columns:[
					...
					{data: function(row, type, val, meta){
					    ...
					    if(row.codigo_estado_cita === 1) {
					        btnCancelarReserva = '<button title="Eliminar" type="button" class="btn btn-danger btn-sm mx-1" onclick="cancelarReserva(\'' + row.codigo_cita + '\')"><i data-feather="x"></i> </button>';
					    } else {
					        btnCancelarReserva = '<button title="Eliminar" type="button" class="btn btn-danger btn-sm mx-1 disabled"><i data-feather="x"></i> </button>'; 
					    }
					...
					btnEditarReserva =    '<button type="button" class="btn btn-info btn-sm btnModal_ActualizaServicio" onclick="obtenercita('+row.codigo_cita+')"><i data-feather="edit-2"></i></button>';
...
// 				}
			...
			$('#ver_id_codigo_mascota').val(item.codigo_mascota)
			$('#ver_id_nombre_mascota').val(item.mascota.nombre_mascota)
			$('#ver_id_color_mascota').val(item.mascota.color.nombre_color_mascota)
			
			$('#ver_id_sexo_mascota').val(item.mascota.sexo.nombre_sexo_mascota) 
			$('#ver_id_especie_mascota').val(item.mascota.especie.nombre_especie_mascota)
			$('#ver_id_raza_mascota').val(item.mascota.raza.nombre_raza_mascota)
			
			$('#ver_id_codigo_servicio').val(item.servicio.codigo_servicio)
			$('#ver_id_nombre_servicio').val(item.servicio.descripcion_servicio)
			$('#ver_id_tipo_servicio').val(item.servicio.tiposervicio.nombre_tipo_servicio)
			$('#ver_id_especialidad_servicio').val(item.servicio.especialidad.nombre_especialidad)
			
			$('#ver_id_dia_servicio').val(item.servicio.diasemana.nombre_dia_semana)
			let dia=new Date(item.fecha_programada_cita)
			$('#ver_id_fecha_cita').val(dia)

				$('#ver_id_descripcion_servicio').val(item.servicio.descripcion_servicio)
			
			$('#ver_id_especialista_servicio').val(item.servicio.usuario.apellido_usuario +" " +item.servicio.usuario.nombre_usuario )
			$('#ver_id_hora_inicio_servicio').val(item.servicio.inicio_turno_servicio)
			$('#ver_id_hora_fin_servicio').val(item.servicio.fin_turno_servicio)
			
			$('#ver_id_motivo_cita').val(item.motivo_cita)
//			$('#id_diagnostico_cita').val(item.)
			let html = '<div class="dropdown-img-start imagenCard" style="background-image: url(data:image/png;base64,'+item.mascota.foto_mascota+');height: 174px;"></div>'
		   ...
		   $.getJSON("obtenerhistorialclinico", {"codigoCita": codigoCita}, function(lista) {
			$.each(lista, function(index, item) {
					...
					$('#ver_id_diagnostico_cita').val(item.motivo_detalle_cita_historial_clinico)
			})

			})


			$('#id_modal_verReserva').modal('show')
...
// 		   $.getJSON("obtenercita", {"codigoCita": codigoCita}, function(lista) {
// 			   if(lista.length == 0){
// 				   mostrarMensajeAdvertencia("No se encontraron Registros")
// 			   }else{
// 				   $.each(lista, function(index, item) {
...
// 			}   
	...
	$(document).ready(function() {
		...
		const modalVerReserva = $('#id_modal_verReserva'); 
		
		const btnModalverReserva = $('#id_btnModal_verReserva');
		btnModalverReserva.click(function() {
			debugger
